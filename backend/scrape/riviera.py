"""
Riviera 2026 Website Scraper
=============================
Scrapes https://riviera.vit.ac.in/ using Playwright (React SPA).
Outputs structured JSON to scrape/riviera_data.json.

Usage:
    python scrape/riviera.py
"""
...
def scrape_events_detail(page, base_url: str, category: str) -> list:
    """
...
def main():
    output_path = Path(__file__).parent / "riviera_data.json"
    all_data = []

    print("=" * 60)
    print("[*] Riviera 2026 Scraper")
    print("=" * 60)
